...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        output, cache1 = affine_forward(X, self.params["W1"], self.params["b1"])
        output, cache2 = relu_forward(output)
        scores, cache3 = affine_forward(output, self.params["W2"], self.params["b2"])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        ############################################################################
        loss, backflow_grads = softmax_loss(scores, y)
        backflow_grads, grads["W2"], grads["b2"] = affine_backward(backflow_grads, cache3)
        backflow_grads = relu_backward(backflow_grads, cache2)
        backflow_grads, grads["W1"], grads["b1"] = affine_backward(backflow_grads, cache1)
